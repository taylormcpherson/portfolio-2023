...
const projects = [
  ...
  },
  {
    ...
    description:
      "Archival storytelling of historic Music Row using maps and multi-media.",
    url: "https://musicrow.countrymusichalloffame.org/",
    img: CmhfImage,
    imgAlt:
      "Image of Music Row's Home Page on a laptop, tablet, and mobile devices.",
  },
  {
    ...
    img: HeiferImage,
    imgAlt:
      "Three mobile interface images of Heifer's optimized donation form.",
  },
  {
    title: "Sutherland Furniture",
    description:
      "Luxury e-commerce site overhaul with sibling brand, Perennials Fabrics.",
  ...
  },
  {
    ...
    img: PernImage,
    imgAlt:
      "Image of Perennials Fabrics navigation experience on a laptop and mobile device.",
  },
  {
    title: "A Great Blog",
    ...
    <Layout>
      ...
      >
        ...
        <h2 className={textStyles.description}>
          building accessible, performant, and delightful tools for us humans on
          the internet.
        </h2>
